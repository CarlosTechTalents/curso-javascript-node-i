...
// Sobre el ejercicio 06 cambiar la edad por fecha de nacimiento
...
var mascotas = [
	{
		nombre: 'Kira',
		fechaDeNacimiento: '2011-05-06',
		vacunasPuestas: ['Hepatitis'],
		vacunasAPoner: []
	},
	{
		nombre: 'Bob',
		fechaDeNacimiento: '2007-09-16',
		vacunasPuestas: [],
		vacunasAPoner: []
	},
	{
		nombre: 'Tom',
		fechaDeNacimiento: '2012-12-05',
		vacunasPuestas: ['Parvovirosis', 'Moquillo'],
		vacunasAPoner: []
	},
	{
		nombre: 'Einstein',
		fechaDeNacimiento: '2004-11-26',
		vacunasPuestas: ['Parvovirosis', 'Moquillo'],
		vacunasAPoner: []
	},
	{
		nombre: 'Laila',
		fechaDeNacimiento: '2017-09-23',
